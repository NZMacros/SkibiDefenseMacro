	...
	Loop {
		...
		Loop 5 {
			...
			Loop 240 {
				...
				wait(1) ; Timeout 4 mins in the case of a ROBLOX update
			}
			...
			Loop 180 {
				...
				if (ImgSearchReconnect("ChapterCheck") = 1) {
			...
			Loop 180 {
				...
				if ((ImgSearchReconnect2("ChapterCheck", 4) = 0) || (ImgSearchReconnect2("ChapterCheck") = 1)) {
					; nm_setStatus("Detected", "Game Loaded")
					success := 1
					break 2
				}
