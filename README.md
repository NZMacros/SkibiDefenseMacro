...
The only official sources are:
 - the GitHub repository (https://github.com/NZMacros/SkibiDefenseMacro)
...
<br>
An open-source Skibi Defense macro written in AutoHotkey!<br>
</div>
