...
if [%1]==[] (
    echo ^<%red%This script must be run from Skibi Defense Macro^^!%reset%
...
echo %green%Update complete^^! Starting Skibi Defense Macro in 10 seconds.%reset%
<nul set /p =%green%Press any key to skip . . . %reset%
timeout /t 10 >nul

start "" "!folder!\submacros\AutoHotkey32.exe" "!folder!\submacros\skibi-defense-macro.ahk"
exit)
