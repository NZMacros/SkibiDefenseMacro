Loop {
    if sd_ImgSearch("Chapters\endlessmode.png", 30)[1] = 0 { ; switch tabs to endshield mode
        MouseMove(sd_ImgSearch("Chapters\endlessmode.png", 10)[2] - 21, sd_ImgSearch("Chapters\endlessmode.png", 10)[3] + 29), MouseMove(sd_ImgSearch("Chapters\endlessmode.png", 10)[2] - 20, sd_ImgSearch("Chapters\endlessmode.png", 10)[3] + 30)
...
JoinChar() {
    ...
    if sd_ImgSearch("Chapters\endshield.png", 10)[1] = 0 { ; if this succeeds, move the mouse here and join
        MouseMove(sd_ImgSearch("Chapters\endshield.png", 10)[2] + 699, sd_ImgSearch("Chapters\endshield.png", 10)[3] + 89), MouseMove(sd_ImgSearch("Chapters\endshield.png", 10)[2] + 700, sd_ImgSearch("Chapters\endshield.png", 10)[3] + 90)
        Send "{Click}"
        Sleep 5000
        ...
        if sd_ImgSearch("Chapters\endshieldgame.png", 10)[1] = 0 {
            ...
            Loop {
                if sd_ImgSearch("Chapters\endtop.png", 10)[1] = 0 {
                    break
                }
                Send "{WheelUp}"
            }
