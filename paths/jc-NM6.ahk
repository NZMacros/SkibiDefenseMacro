...
JoinChar() {
    ...
    if sd_ImgSearch("Chapters\nm6.png", 10)[1] = 0 { ; if this succeeds, move the mouse here and join
        MouseMove(sd_ImgSearch("Chapters\nm6.png", 10)[2] + 699, sd_ImgSearch("Chapters\nm6.png", 10)[3] + 89), MouseMove(sd_ImgSearch("Chapters\nm6.png", 10)[2] + 700, sd_ImgSearch("Chapters\nm6.png", 10)[3] + 90)
        Send "{Click}"
        Sleep 5000
